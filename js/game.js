...
let intervalIds = [];
let backgroundMusic = new Audio("/El-Pollo-Loco/assets/audio/backgroundMusic.mp3");
let intro_music = new Audio("/El-Pollo-Loco/assets/audio/bossIntro.mp3");
let winning_sound = new Audio("/El-Pollo-Loco/assets/audio/win.mp3");
let sound = true;
let music = true;
...
/**
 * Stops the game by clearing intervals, canceling animation frame, clearing the world,
 * filling the level, resetting the level, and setting the game state to stopped.
 *
 * @param {type} paramName - description of parameter
 * @return {type} description of return value
 */
